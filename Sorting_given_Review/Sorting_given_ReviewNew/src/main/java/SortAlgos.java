...
/**
 * A collection of various sorting algorithms for sorting an array of items with
 * int key
 */
...
public final class SortAlgos
{
	 ...
	 *
	 * Returns a NullPointerException when the array is empty Returns a sorted array
	 * with the same length as the param array vec
	 *
	 * @param vec
	 *            the array to be sorted
	 * @exception NullPointerException
	 *                if <code>vec</code> is not initialized
	 */
	public static void bubbleSort(Item[] vec) throws NullPointerException
	{
		if (vec == null)
		{
	 ...
	 *                if <code>vec</code> is not initialized
	 */
	public static void selectionSort(Item vec[]) throws NullPointerException
	{
		if (vec == null)
		{
			throw new NullPointerException();
	 ...
	 *                if <code>vec</code> is not initialized
	 */
	public static void insertionSort(Item vec[]) throws NullPointerException
	{
		if (vec == null)
		{
			throw new NullPointerException();
	 ...
	 *            the array to be sorted
	 * @param range
	 *            upper bound for insertion position
	 * @param x
	 *            the value determining the position
	...
	private static int findInsPosition(Item[] vec, int range, int x)
	{
		...
		int i, j, k;
		i = 0;
		j = range; // initialize lower index i and upper index j
		do
		{
	...
	/**
	 * Inserts array component into a sorted range below the component such that the
	 * result is again sorted
	 *
	 * @param vec
	 *            the array in which this happens
	 * @param insPos
	 *            the insertion position
	 * @param fromPos
	 *            the position whose value has to be inserted at <code>insPos</code>
	 */
	private static void insertAtPosition(Item[] vec, int insPos, int fromPos)
	{
		if (insPos == fromPos)
		{
			return;
	 ...
	 *                if <code>vec</code> is not initialized
	 */
	public static void mergeSort(Item vec[]) throws NullPointerException
	{
		if (vec == null)
		{
			throw new NullPointerException();
	...
	private static void merge(Item[] vec, int left, int middle, int right)
	{
		...
		if (j == n)
		{ // second array region is completely handled,
	 ...
	 *                if <code>vec</code> is not initialized
	 */
	public static void quickSort(Item[] vec) throws NullPointerException
	{
		if (vec == null)
		{
			throw new NullPointerException();
	 ...
	 *
	 * @param vec
	 *            the array to which this happens
	 */
	 ...
	 *            the array in which this happens
	 */
	public static void heapSort(Item[] vec) throws NullPointerException
	{
		if (vec == null)
		{
			throw new NullPointerException();
